...
$card="Bane_of_Doom"; 						card($class, $card);
?></div>

<div class="tier">
<h1>Tier 2: Great</h1><?php
$card="Dark_Bargain"; 							card($class, $card);
...
$card="Demonheart"; 						card($class, $card);
...
$card="Twisting_Nether"; 					card($class, $card);
...
$card="Anima_Golem";						card($class, $card);
$card="Dreadsteed"; 						card($class, $card);
